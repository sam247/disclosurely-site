...
function DirectiveContent() {
  ...
  return (
    <div className="bg-white">
      <Head>
        <title>EU Whistleblowing Directive | Disclosurely</title>
        <meta
          name="description"
          content="Meet EU Whistleblowing Directive requirements with anonymous reporting, encrypted messaging, SLAs, and audit-ready workflows."
        />
      </Head>
