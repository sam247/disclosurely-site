                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    {plan.highlights.map((item) => {
                      // Enterprise plan shows customIntegrations and api with gray icons
                      const isEnterpriseGrayFeature =
                        plan.name === t("pricing.plans.enterprise.name") &&
                        (item === t("pricing.features.customIntegrations") || item === t("pricing.features.api"));
                      return (
                        <div key={item} className="flex items-center space-x-3">
                          <CheckCircle
                            className={`h-5 w-5 ${isEnterpriseGrayFeature ? "text-gray-400" : "text-green-600"}`}
                          />
                  ...
                  {plan.cta ? (
                    ...
                    <Link
                      ...
                      className="mt-6 block w-full rounded-md border border-input bg-background px-4 py-2 text-center text-sm shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground"
                    >
      ...
      <section className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">Enterprise-grade security for every team</h2>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="rounded-lg border bg-white px-6">
              ...
              <AccordionContent className="pt-2 text-gray-600">{t("pricing.faq.trial.answer")}</AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2" className="rounded-lg border bg-white px-6">
              ...
              <AccordionContent className="pt-2 text-gray-600">{t("pricing.faq.limit.answer")}</AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3" className="rounded-lg border bg-white px-6">
              ...
              <AccordionContent className="pt-2 text-gray-600">{t("pricing.faq.change.answer")}</AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="rounded-lg border bg-white px-6">
              ...
              <AccordionContent className="pt-2 text-gray-600">{t("pricing.faq.security.answer")}</AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      </section>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Link href={`${langPrefix}/features`} className="group block">
              <div className="h-full rounded-lg bg-gray-50 p-6 shadow-sm transition-shadow hover:shadow-lg">
                <h3 className="mb-2 text-lg font-semibold text-gray-900 group-hover:text-blue-600">Platform Features</h3>
            ...
            <Link href={`${langPrefix}/compliance-software`} className="group block">
              <div className="h-full rounded-lg bg-gray-50 p-6 shadow-sm transition-shadow hover:shadow-lg">
                <h3 className="mb-2 text-lg font-semibold text-gray-900 group-hover:text-blue-600">Compliance Software</h3>
                <p className="text-sm text-gray-600">
            ...
            <Link href={`${langPrefix}/vs-speakup`} className="group block">
              <div className="h-full rounded-lg bg-gray-50 p-6 shadow-sm transition-shadow hover:shadow-lg">
                <h3 className="mb-2 text-lg font-semibold text-gray-900 group-hover:text-blue-600">Compare Solutions</h3>
                <p className="text-sm text-gray-600">
