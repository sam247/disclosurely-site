...
import { CheckCircle2, Shield, Lock, Users, TrendingUp, Calendar, Clock, ArrowRight, FileText } from "lucide-react";
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Early detection of fraud and theft through anonymous reporting channels that employees actually trust and use.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-blue-600" />
                    <span>Prevent HR disputes from escalating to costly employment tribunals with structured, documented reporting processes.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="mt-1 h-5 w-5 flex-shrink-0 text-blue-600" />
                    <span>Protect your business reputation and retain good employees by creating a culture where concerns are heard and addressed.</span>
                  </li>
                </ul>
              </div>
              <div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="rounded-2xl bg-white p-8 transition-shadow hover:shadow-lg">
                <CardContent className="p-0">
                  ...
                  <h3 className="mb-3 text-xl font-semibold text-gray-900">Simple Setup</h3>
                  <p className="text-gray-600">
                    Get started in minutes with browser-based access. No complex IT integration or lengthy onboarding required.
                  </p>
                </CardContent>
              </Card>
            </div>
