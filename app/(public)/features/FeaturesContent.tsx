      ...
      <section className="bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            <h2 className="mb-6 text-3xl font-bold text-gray-900 md:text-4xl">{t("features.core.title")}</h2>
          </div>

          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Card className="rounded-2xl p-6 transition-shadow hover:shadow-lg">
              <CardContent className="p-0">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 sm:h-16 sm:w-16">
                  <Shield className="h-6 w-6 text-blue-600 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-3 text-lg font-semibold text-gray-900 sm:text-xl">
                  {t("features.core.items.anonymous.title")}
                </h3>
                <p className="text-sm text-gray-600 sm:text-base">{t("features.core.items.anonymous.description")}</p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl p-6 transition-shadow hover:shadow-lg">
              <CardContent className="p-0">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 sm:h-16 sm:w-16">
                  <Brain className="h-6 w-6 text-blue-600 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-3 text-lg font-semibold text-gray-900 sm:text-xl">
                ...
                <p className="text-sm text-gray-600 sm:text-base">
                  {t("features.core.items.ai.description") ||
                    "DeepSeek AI analyzes cases, identifies risk patterns, and provides actionable insights to help you resolve issues faster."}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl p-6 transition-shadow hover:shadow-lg">
              <CardContent className="p-0">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 sm:h-16 sm:w-16">
                  <BarChart3 className="h-6 w-6 text-gray-700 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-3 text-lg font-semibold text-gray-900 sm:text-xl">
                  {t("features.core.items.dashboard.title")}
                </h3>
                <p className="text-sm text-gray-600 sm:text-base">{t("features.core.items.dashboard.description")}</p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl p-6 transition-shadow hover:shadow-lg">
              <CardContent className="p-0">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 sm:h-16 sm:w-16">
                  <CheckCircle className="h-6 w-6 text-blue-600 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-3 text-lg font-semibold text-gray-900 sm:text-xl">
                  {t("features.core.items.compliance.title")}
                </h3>
                <p className="text-sm text-gray-600 sm:text-base">{t("features.core.items.compliance.description")}</p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl p-6 transition-shadow hover:shadow-lg">
              <CardContent className="p-0">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 sm:h-16 sm:w-16">
                  <Smartphone className="h-6 w-6 text-gray-700 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-3 text-lg font-semibold text-gray-900 sm:text-xl">
                  {t("features.core.items.mobile.title")}
                </h3>
                <p className="text-sm text-gray-600 sm:text-base">{t("features.core.items.mobile.description")}</p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl p-6 transition-shadow hover:shadow-lg">
              <CardContent className="p-0">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 sm:h-16 sm:w-16">
                  <Plug className="h-6 w-6 text-blue-600 sm:h-8 sm:w-8" />
                </div>
                <h3 className="mb-3 text-lg font-semibold text-gray-900 sm:text-xl">
                  {t("features.core.items.integration.title")}
                </h3>
                <p className="text-sm text-gray-600 sm:text-base">{t("features.core.items.integration.description")}</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 text-center">
            <h2 className="mb-2 text-2xl font-bold text-gray-900 sm:text-3xl">Next Steps</h2>
            <p className="text-gray-600">Ready to get started with Disclosurely?</p>
          </div>

          <div className="grid gap-6 md:grid-cols-3">
            <a href="https://app.disclosurely.com/auth/signup" className="group block">
              <div className="h-full rounded-lg bg-white p-6 shadow-sm transition-shadow hover:shadow-lg">
                <h3 className="mb-2 text-lg font-semibold text-gray-900 group-hover:text-blue-600">Start Free Trial</h3>
            ...
            <Link href={`${langPrefix}/pricing`} className="group block">
              <div className="h-full rounded-lg bg-white p-6 shadow-sm transition-shadow hover:shadow-lg">
                <h3 className="mb-2 text-lg font-semibold text-gray-900 group-hover:text-blue-600">View Pricing</h3>
                <p className="text-sm text-gray-600">
                  Explore our transparent pricing plans starting at £19.99/month with unlimited reports and
                  military-grade security.
                </p>
              </div>
            </Link>

            <Link href={`${langPrefix}/contact`} className="group block">
              <div className="h-full rounded-lg bg-white p-6 shadow-sm transition-shadow hover:shadow-lg">
                <h3 className="mb-2 text-lg font-semibold text-gray-900 group-hover:text-blue-600">Contact Sales</h3>
                <p className="text-sm text-gray-600">
